  ...
  <div className="flex flex-col items-center justify-center h-full gap-4">
    <div className="flex flex-col gap-3">
      ...
      <button
        ...
        // disabled={isDisabled}
        className="w-full flex items-center justify-center gap-2 bg-blue-600  text-white py-3 rounded-md text-lg font-medium hover:bg-blue-700 transition-colors cursor-pointer disabled:bg-gray-300"
      >
        <div className="flex items-csnter justify-csnter gap-4">
          <img src = {"/images/google.png"} alt="Google Logo Image" className="w-5 h-5 object-contain align-middle mt-1.5" />
          <span>구글 로그인</span>
        </div>
      </button>
    </div>

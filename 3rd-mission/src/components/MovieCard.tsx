...
export default function MovieCard({movie}: MovieCardProps) {
    ...
    >
        ...
        />
        {isHovered && (
            <div className='absolute inset-0 bg-gradient-to-t from-black/50 to-transparent backdrop-blur-md flex flex-col jsutify-center items-center text-white p-4'>
